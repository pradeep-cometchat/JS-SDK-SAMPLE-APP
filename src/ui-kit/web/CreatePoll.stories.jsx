...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Create-a-poll modal. Question + 2–10 options. Validates empty fields and duplicates before sending.',
      },
    },
  },
};
      ...
      <Centered maxWidth={720} padding={24} minHeight="100vh">
        {!open ? (
          <div style={{ background: 'var(--surface)', padding: 24, borderRadius: 12, border: '1px solid var(--border)', textAlign: 'center' }}>
            ...
            {last && (
              <pre style={{ marginTop: 16, background: 'var(--bg)', padding: 12, borderRadius: 8, fontSize: 12, textAlign: 'left', whiteSpace: 'pre-wrap', wordBreak: 'break-all' }}>
...
export const DefaultForm = Default;
