...
import { Sidebar, ConvItem, CallHistoryList } from '../../components/Sidebar';
import {
  CURRENT_USER, CONVERSATIONS, INITIAL_MESSAGES, CALL_HISTORY,
  DesktopSidebarFrame, DesktopSidebarSlice, noop,
} from '../_helpers';

export default {
  title: 'Web/Sidebar/Sidebar',
  component: Sidebar,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component:
          'Left navigation. Tabs (All, Users, Groups, Calls), search with media filter chips, pinned and recent sections, deep message search, and a footer with the current user + sign-out.',
      },
    },
  },
};
...
export const CallsTab = {
  ...
  parameters: { docs: { description: { story: 'The Calls tab. Clicking a row expands it into a detail card with Call back and Video buttons.' } } },
};
