...
export default {
  title: 'Mobile/Chat Panel/MessageComposer',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component:
          'Composer in a mobile viewport. The format toolbar is hidden on mobile; the attach menu, emoji keyboard, and action menus open as bottom sheets.',
      },
    },
  },
};
